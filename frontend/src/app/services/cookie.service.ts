...
export class CookieService {
  ...
  getAll(): {} {
    ...
    if (document.cookie && document.cookie !== '') {
      ...
      for (const cook of Object.values(split)) {
        const currentCookie: Array<string> = cook.split('=');
  ...
  delete(name: string, path?: string, domain?: string): void {
    ...
    this.set(name, '', new Date('Thu, 01 Jan 1970 00:00:01 GMT'), path, domain, (document.location.protocol === 'https:'), 'Strict');
  }
